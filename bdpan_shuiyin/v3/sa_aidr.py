...
class STRAIDR(nn.Layer):
    def __init__(self, n_in_channel=3, n_out_channel=3,
        ...
        self.mask_conv_a = ConvWithActivation(unet_num_c[2] * 2, unet_num_c[2], kernel_size=3, padding=1, stride=1)
        self.mask_deconv_b = DeConvWithActivation(unet_num_c[2] * 2, unet_num_c[2], kernel_size=3, padding=1, stride=2)
        self.mask_conv_b = ConvWithActivation(unet_num_c[1] * 2, unet_num_c[1], kernel_size=3, padding=1, stride=1)
