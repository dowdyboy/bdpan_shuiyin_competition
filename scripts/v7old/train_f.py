...
parser = argparse.ArgumentParser(description='train shuiyin full image')
# model config
...
parser.add_argument('--out-dir', type=str, default='./output_full', help='out dir')
...
def build_data():
    train_dataset = ShuiyinTrainDataset(
        ...
        hflip_p=0.5, vflip_p=0.5, rotate_p=0.5, color_jit_p=0.0,
