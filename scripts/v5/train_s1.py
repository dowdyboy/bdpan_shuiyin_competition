...
from bdpan_shuiyin.v5.sa_aidr import STRAIDR
from bdpan_shuiyin.v5.loss import ShuiyinLoss
from bdpan_shuiyin.v5.optim import CosineAnnealingRestartLR
from bdpan_shuiyin.v5.dataset import ShuiyinTrainDataset
from bdpan_shuiyin.v5.psnr_ssim import calculate_psnr, calculate_ssim

parser = argparse.ArgumentParser(description='train shuiyin v5')
# model config
# data config
...
# train config
parser.add_argument('--epoch', type=int, default=1000, help='epoch num')
parser.add_argument('--batch-size', type=int, default=8, help='batch size')
parser.add_argument('--out-dir', type=str, default='./output_v5', help='out dir')
...
def build_model():
    from bdpan_shuiyin.v5.init import init_model
    model = STRAIDR(
        unet_num_c=[48, 96, 192, 384, 768],
        fine_num_c=192,
    )
    init_model(model)
