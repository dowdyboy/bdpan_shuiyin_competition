...
from bdpan_shuiyin.v1.loss import ShuiyinLoss
from bdpan_shuiyin.v1.optim import CosineAnnealingRestartLR
from bdpan_shuiyin.v1.dataset import ShuiyinTrainDataset
from bdpan_shuiyin.v1.psnr_ssim import calculate_psnr, calculate_ssim

parser = argparse.ArgumentParser(description='train shuiyin v1')
# model config
# data config
...
parser.add_argument('--out-dir', type=str, default='./output_v1', help='out dir')
...
def build_data():
    train_dataset = ShuiyinTrainDataset(
        ...
        hflip_p=0.3, vflip_p=0.0, rotate_p=0.3, color_jit_p=0.0,
        cutout_big_p=0.0, cutout_small_p=0.0, salt_p=0.0, real_p=0.1,
...
def main():
    ...
    model = build_model()
    loss_func = ShuiyinLoss(mode='psnr', weight=[0.5, 0.5, 0.1])
