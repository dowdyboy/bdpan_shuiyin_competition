...
from bdpan_shuiyin.v3.model import ShuiyinModel
from bdpan_shuiyin.v3.loss import ShuiyinLoss
from bdpan_shuiyin.v3.optim import CosineAnnealingRestartLR
from bdpan_shuiyin.v3.dataset import ShuiyinTrainDataset
from bdpan_shuiyin.v3.psnr_ssim import calculate_psnr, calculate_ssim
...
parser.add_argument('--out-dir', type=str, default='./output_v3', help='out dir')
...
def train_step(trainer: Trainer, bat, bat_idx, global_step):
    ...
    pred_y, pred_mask, pred_o4, pred_o2 = model(bat_x)
    loss = loss_func(pred_y, pred_mask, pred_o4, pred_o2, bat_y, bat_mask)
...
def val_step(trainer: Trainer, bat, bat_idx, global_step):
    ...
    for i in range(0, h, step):
        for j in range(0, w, step):
            ...
            pred_y, pred_mask, pred_o4, pred_o2 = model(clip_x)
            loss = loss_func(pred_y, pred_mask, pred_o4, pred_o2, clip_y, clip_mask)
